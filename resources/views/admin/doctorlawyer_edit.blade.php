    ...
    */
    ...
    $(".actions ul").find('li').eq(1).on("mouseover", "a", function() {
        ...
        if ($(".steps ul").find("li").eq(1).hasClass("current")) {
            ...
            if (professional_title_en.length > 0 
    ...
    $(".actions ul").find('li').eq(1).on("click", "a", function() {
        ...
        if ($(".steps ul").find("li").eq(1).hasClass("current")) {
            ...
            $("section").eq(1).find('input').each(function() {
                ...
                if (ele != "image_professional_title" && ele != "image_profession_license") {
                    if (input.length == 0) {
                        console.log("in")
                            ...
                            <div class="form-group mb-4">
                                ...
                                @if (count($data['drlaw']->placeImages) > 0)
                                    ...
                                    <div style="position : relative" class="col-md-2 product_image">
                                        <a onclick="return confirm('{{ __('messages.are_you_sure') }}')" style="position : absolute; right : 20px" href="{{ route('doctors&lawyers.deletePlaceImage', $image->id) }}" class="close">x</a>
