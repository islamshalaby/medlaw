            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission'])) 
                    ...
                    <li class="menu doctorslawyers">
                        <a href="#doctorslawyers" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                                <span>{{ __('messages.doctors&lawyers') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="doctorslawyers" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active add">
                                    <a href="{{ route('doctors&lawyers.add') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="{{ route('doctors&lawyers.index') }}"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu services">
                        <a href="#services" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="services" data-parent="#accordionExample">
                            @if(Auth::user()->add_data) 
                                <li class="active add">
                                    <a href="{{ route('services.add') }}"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="{{ route('services.index') }}"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="menu reservations">
                        <a href="{{ route('resrvations.index') }}" class="dropdown-toggle first-link">
                            <div class="">
                    ...
                    <li class="menu holidays">
                        <a href="{{ route('holidays.index') }}" class="dropdown-toggle first-link">
                            <div class="">
