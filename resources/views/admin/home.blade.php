...
<div class="row" >
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th><div class="th-content">{{ __('messages.doctor|lawyer') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.type') }}</div></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><div class="td-content customer-name">{{ App::isLocale('en') ? $recent_reservation->doctorLawyer->app_name_en : $recent_reservation->doctorLawyer->app_name_ar }}</div></td>
                                <td><div class="td-content product-brand">{{ $recent_reservation->type == 'doctor' ? __('messages.doctor') : __('messages.lawyer') }}</div></td>
                                <td>
    ...
    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
        <div class="widget widget-table-three">
            ...
            <div class="widget-heading">
                <h5 class="">{{ __('messages.top_dr_lawyer_reserved') }}</h5>
            </div>
            ...
            <div class="widget-content">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <tr>
                                <th><div class="th-content">{{ __('messages.name') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.type') }}</div></th>
                                <th><div class="th-content th-heading">{{ __('messages.specialization') }}</div></th>
                                <th><div class="th-content">{{ __('messages.total_cost') }}</div></th>
                                <th><div class="th-content">{{ __('messages.reservations_number') }}</div></th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($data['most_dr_lawyer_reserved'] as $reserved)
                            <tr>
                                <td><div class="td-content product-name">{{ App::isLocale('en') ? $reserved->app_name_en : $reserved->app_name_ar }}</div></td>
                                <td><div class="td-content">{{ $reserved->type }}</span></div></td>
                                <td><div class="td-content"><span class="discount-pricing">{{ App::isLocale('en') ? $reserved->professional_title_en : $reserved->professional_title_ar }}</span></div></td>
                                <td><div class="td-content"><span class="pricing">{{ $reserved->costSum . " " . __('messages.dinar') }}</span></div></td>
                                <td><div class="td-content">{{ $reserved->cnt }}</div></td>
                            </tr>
                            @endforeach
    ...
    <a href="/admin-panel/products/show?expire=soon" >
        <div class="widget widget-card-four">
            <div class="widget-content">
                <div class="w-content">
                    <div class="w-info">
                        <h6 class="value">{{ $data['reservations'] }}</h6>
                        <p class=""> {{ __('messages.reservations_number') }}</p>
                    </div>
                    <div class="">
                        <div class="w-icon">
                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="16.5" y1="9.4" x2="7.5" y2="4.21"></line><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>
