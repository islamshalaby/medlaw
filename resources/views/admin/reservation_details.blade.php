            ...
            <div class="table-responsive"> 
                <table class="table table-bordered mb-4">
                    <tbody>
                            ...
                            <tr>
                                <td class="label-table" > {{ __('messages.doctor|lawyer') }}</td>
                                <td>{{ App::isLocale('en') ? $data['reservation']->doctorLawyer->app_name_en : $data['reservation']->doctorLawyer->app_name_ar }}</td>
                            </tr>
                            <tr>
                                <td class="label-table" > {{ __('messages.type') }}</td>
                                <td>{{ $data['reservation']['type'] == 'doctor' ? __('messages.doctor') : __('messages.lawyer') }}</td>
                            </tr>
                            <tr>
