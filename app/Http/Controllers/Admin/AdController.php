...
class AdController extends AdminController{
    ...
    public function AddGet(){
        $data['doctors'] = DoctorsLawyers::where('type' , 'doctor')->where('active' , 1)->where('profile_completed' , 3)->get();
        $data['lawyers'] = DoctorsLawyers::where('type' , 'lawyer')->where('active' , 1)->where('profile_completed' , 3)->get();
